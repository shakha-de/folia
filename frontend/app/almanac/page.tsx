...
export default function AlmanacPage() {
  return (
    <div className="bg-background-light dark:bg-background-dark text-slate-900 dark:text-white min-h-screen selection:bg-primary selection:text-background-dark">
      <Header />
      <div className="px-4 md:px-10 lg:px-40 py-12 lg:py-16">
